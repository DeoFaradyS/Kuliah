...
public class StrokingExample extends Frame {
  ...
  public void paint(Graphics g) {
    // The line `Graphics2D g2d = (Graphics2D) g;` is casting the `Graphics` object `g` to a
    // `Graphics2D` object `g2d`. This is done to access the extended 2D graphics capabilities provided
    // by the `Graphics2D` class, which includes additional methods for drawing shapes, text, and
    // images with more control over rendering attributes like stroke thickness, color, and
    // transformations.
